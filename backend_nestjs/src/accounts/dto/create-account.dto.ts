...
import { IsString, IsEmail, IsOptional, IsEnum, Length, Matches, IsArray, IsInt } from 'class-validator';
...
export class CreateAccountDto {
  ...
  @ApiProperty({ description: '分配的角色ID列表', example: [1, 2], required: false })
  @IsOptional()
  @IsArray()
  @IsInt({ each: true })
  roleIds?: number[];
